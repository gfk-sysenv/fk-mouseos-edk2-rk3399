...
mkdir $WORKSPACE
cd $WORKSPACE
git clone --recursive -o 46f4c9677c615d862649459392f8f55b3e6567c2 https://github.com/tianocore/edk2.git --depth 1
git clone --recursive -o 1e2ca640be54d7a4d5d804c4f33894d099432de3 https://github.com/tianocore/edk2-non-osi.git --depth 1
git clone --recursive -o 861c200cda1417539d46fe3b1eba2b582fa72cbb https://github.com/tianocore/edk2-platforms.git --depth 1
